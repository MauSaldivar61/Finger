function make_print_files(folder_prints, name_struct, G_H_bits, G_S_bits, G_F_bits,...
...
for lay = 1:size(G_S_bits,3)
    imwrite( logical(G_H_bits(:,:,lay)),[folder_prints,'\',name_struct,'\Mat1\','II_',num2str(lay,'%04.f'),'.bmp']);
    imwrite( logical(0*G_H_bits(:,:,lay)),[folder_prints,'\',name_struct,'\Mat2\','II_',num2str(lay,'%04.f'),'.bmp']);
    imwrite( logical(0*G_H_bits(:,:,lay)),[folder_prints,'\',name_struct,'\Mat3\','II_',num2str(lay,'%04.f'),'.bmp']);
    imwrite( logical(G_F_bits(:,:,lay)),[folder_prints,'\',name_struct,'\Mat4\','II_',num2str(lay,'%04.f'),'.bmp']);
    imwrite( logical(0*G_H_bits(:,:,lay)),[folder_prints,'\',name_struct,'\Mat5\','II_',num2str(lay,'%04.f'),'.bmp']);
    imwrite( logical(G_S_bits(:,:,lay)),[folder_prints,'\',name_struct,'\Mat6\','II_',num2str(lay,'%04.f'),'.bmp']);
end
